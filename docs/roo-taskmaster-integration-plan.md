...
| Infraestrutura Tradicional                               | Engenheiro de Data Center                  | Responsável pelo design e manutenção de data centers físicos    |
...
| Infraestrutura em Nuvem                                  | Cloud Operations Specialist                | Monitora e otimiza operações em ambientes cloud                 |
...
| DevOps e Automação                                       | Automation Test Engineer                   | Cria e mantém pipelines de testes automatizados                 |
...
| Banco de Dados e Dados                                   | Data Steward                               | Garante a governança e qualidade dos dados                      |
